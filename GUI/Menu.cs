...
namespace GUI
{
    public partial class Menu : Form
    {
        ...
        private Borrowed borrowed = null;
        ...
        */
        ...
        {
            sachOnTraLv.DataSource = null;
            docgiaCBOnMuonSach.Text = "";
            loadTableMuonSach();
            loadTableTraSach();
        }
        ...
        private void guna2Button2_Click_1(object sender, EventArgs e)
        {
            ...
            borrowed.sach = new List<string>();
            if (dg != null)
            {
                borrowed.TenDocGia = dg.TenDG;
                borrowed.SdtDocGia = dg.SDT;
            }
            borrowed.NgayMuon = ngayMuonOnMuonSach.Value;
            borrowed.NgayHenTra = nhtOnTraSach.Value;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            if(borrowed != null)
            {
                ...
                b.Append("Phiếu mượn \n\n");
                b.Append("Tên độc giả:  " + borrowed.TenDocGia + "\n");
                b.Append("Số điện thoại:  " + borrowed.SdtDocGia + "\n");
                b.Append("Ngày mượn:  " + borrowed.NgayMuon.ToString() + "\n");
                b.Append("Ngày hẹn trả:  " + borrowed.NgayHenTra.ToString() + "\n");
                b.Append("Sách đã mượn: \n");
                 foreach(string item in borrowed.sach) {
                    b.Append("   - " + item+ "\n");
                }

                e.Graphics.DrawString(b.ToString(), new Font("Centuey Gothic", 23, FontStyle.Regular), Brushes.Black, new PointF(200, 220));
